...
class RockPaperScissors extends JFrame {
    ...
    public void setup() {
        ...
        panel.setBounds(400, 20, 130, 150);
        JLabel score=new JLabel();
        score.setText("    Score");
        score.setFont(new Font("Serif",Font.BOLD,25));
        computerScore=new JLabel();
        computerScore.setText(" Computer : 0");
        computerScore.setFont(new Font("Serif",Font.PLAIN,18));
        playerScore=new JLabel();
        playerScore.setText(" Player : 0");
        playerScore.setFont(new Font("Serif",Font.PLAIN,18));
        Border border = BorderFactory.createLineBorder(Color.decode("#702670"), 2);
        score.setBorder(border);
        playerScore.setBorder(border);
        computerScore.setBorder(border);
        panel.add(score);
